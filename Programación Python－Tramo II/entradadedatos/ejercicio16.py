...
El resultado se mostrará en pantalla en un mensaje que indique la cantidad de 
segundos ingresados y su equivalente en días, horas, minutos y segundos.
...
tiempo_en_segundos = int(input("Ingrese el tiempo total en segundos: "))
...
print (f"{tiempo_en_segundos} segundos equivalen a: {dias} dias {horas} horas {minutos} minutos {segundos_restantes} segundos")